...
- Free accounts get 3 lifetime credits shared across their Clerk user id, browser fingerprint, and salted IP hash, so guest usage carries over after sign-in. Free accounts can save 1 resume.
- Pro subscribers ($19/month, or $14/month billed annually) get 100 credits per calendar month, automatic cover letters with each tailor run, full missing-requirements analysis with one-click draft bullets, and up to 10 saved resumes.
