      ...
      <Grid.Col span={{ base: 12, md: 6 }}>
        <Stack gap="lg" align="center">
          <Stack gap="sm" align="center">
            ...
            >
              Paste a job post. Get a tailored resume and a matching cover letter.
            </Title>
            <Text size="md" c="dimmed" ta="center" maw={480} lh={1.5}>
              Our AI rewrites your bullets the way recruiters want to read them and shows every
              change as an inline diff. You keep only what sounds like you.
            </Text>
          </Stack>
          ...
          <Stack gap={6} align="center" w="100%">
            ...
            <Text size="xs" c="dimmed" ta="center">
              No credit card required. Your resume is never used to train AI.
            </Text>
          </Stack>
